...
-- ALTER TABLE llx_conditionreport_conditionreportroomdet ADD INDEX idx_conditionreport_conditionreportroom_rowid (rowid);
-- ALTER TABLE llx_conditionreport_conditionreportroomdet ADD CONSTRAINT llx_conditionreport_conditionreportroom_fk_user_creat FOREIGN KEY (fk_user_creat) REFERENCES llx_user(rowid);
