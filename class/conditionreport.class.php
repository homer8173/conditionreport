...
class Conditionreport extends CommonObject
{
    ...
    public $fields = array(
        ...
        'fk_soc' => array('type' => 'integer:Societe:societe/class/societe.class.php:1:((status:=:1) AND (entity:IN:__SHARED_ENTITIES__))', 'label' => 'ThirdParty', 'picto' => 'company', 'enabled' => '1', 'position' => 50, 'notnull' => -1, 'visible' => 1, 'index' => 1, 'css' => 'maxwidth500 widthcentpercentminusxx', 'csslist' => 'tdoverflowmax150', 'help' => "OrganizationEventLinkToThirdParty", 'validate' => '1',),
        'fk_lessor' => array('type' => 'integer:ImmoOwner:ultimateimmo/class/immoowner.class.php:1:((status:=:1)', 'label' => 'Lessor', 'picto' => 'company', 'enabled' => '1', 'position' => 51, 'notnull' => -1, 'visible' => 1, 'index' => 1, 'css' => 'maxwidth500 widthcentpercentminusxx', 'csslist' => 'tdoverflowmax150', 'help' => "OrganizationEventLinkToThirdParty", 'validate' => '1',),
        'fk_tenant' => array('type' => 'integer:ImmoOwner:ultimateimmo/class/immorenter.class.php:1:((status:=:1)', 'label' => 'Tenant', 'picto' => 'company', 'enabled' => '1', 'position' => 52, 'notnull' => -1, 'visible' => 1, 'index' => 1, 'css' => 'maxwidth500 widthcentpercentminusxx', 'csslist' => 'tdoverflowmax150', 'help' => "OrganizationEventLinkToThirdParty", 'validate' => '1',),
        ...
        'date_exit' => array('type' => 'datetime', 'label' => 'DateExit', 'enabled' => '1', 'position' => 503, 'notnull' => 1, 'visible' => 1, 'help' => "DateExitDetails",),
        'date_signature_lessor' => array('type' => 'datetime', 'label' => 'DateSignatureLessor', 'enabled' => '1', 'position' => 504, 'notnull' => 1, 'visible' => 1, 'help' => "DateSignatureLessorDetails",),
        'date_signature_tenant' => array('type' => 'datetime', 'label' => 'DateSignatureTenant', 'enabled' => '1', 'position' => 505, 'notnull' => 1, 'visible' => 1, 'help' => "DateSignatureTenantDetails",),
        'type_heater' => array('type' => 'sellist:c_type_chauffage:label:rowid::(active:=:1)', 'label' => 'type_heater', 'enabled' => '1', 'position' => 506, 'notnull' => 0, 'visible' => 1, 'help' => "type_heaterDetails",),
        'type_water_heater' => array('type' => 'sellist:c_type_chauffage:label:rowid::(active:=:1)', 'label' => 'type_water_heater', 'enabled' => '1', 'position' => 507, 'notnull' => 0, 'visible' => 1, 'help' => "type_water_heaterDetails",),
        'type_cooker' => array('type' => 'sellist:c_type_chauffage:label:rowid::(active:=:1)', 'label' => 'type_cooker', 'enabled' => '1', 'position' => 508, 'notnull' => 0, 'visible' => 1, 'help' => "type_cookerDetails",),
    );
    public $rowid;
    public $ref;
    public $label;
