...
/**
 *  \file       conditionreportroom_note.php
 *  \ingroup    conditionreport
 *  \brief      Tab for notes on Conditionreportroom
 */
...
$title = $langs->trans('Conditionreportroom').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Conditionreportroom"), -1, $object->picto);
