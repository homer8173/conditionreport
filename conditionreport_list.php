...
/**
 *   	\file       conditionreport_list.php
 *		\ingroup    conditionreport
 *		\brief      List page for conditionreport
 */
...
if ($enablepermissioncheck) {
	...
	$permissiontodelete = $user->hasRight('conditionreport', 'conditionreport', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Conditionreport';
	$objectlabel = 'Conditionreport';
...
$title = $langs->trans("Conditionreports");
//$help_url = "EN:Module_Conditionreport|FR:Module_Conditionreport_FR|ES:Módulo_Conditionreport";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/conditionreport/conditionreport_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/conditionreport/conditionreport_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendConditionreportRef";
$modelmail = "conditionreport";
$objecttmp = new Conditionreport($db);
