...
/**
 *  \file       conditionreport_note.php
 *  \ingroup    conditionreport
 *  \brief      Tab for notes on Conditionreport
 */
...
$langs->loadLangs(array("conditionreport@conditionreport", "companies"));
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->conditionreport->multidir_output[empty($object->entity) ? $conf->entity : $object->entity]."/".$object->id;
}
...
$title = $langs->trans('Conditionreport').' - '.$langs->trans("Notes");
//$title = $object->ref." - ".$langs->trans("Notes");
$help_url = '';
//$help_url='EN:Customers_Orders|FR:Commandes_Clients|ES:Pedidos de clientes';

llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-conditionreport page-card_notes');
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Conditionreport"), -1, $object->picto);
