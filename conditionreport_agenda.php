...
/**
 *  \file       conditionreport_agenda.php
 *  \ingroup    conditionreport
 *  \brief      Tab of events on Conditionreport
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Conditionreport")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Conditionreport"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_conditionreport_'.$object->id;
