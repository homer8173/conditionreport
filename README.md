# CONDITIONREPORT FOR [DOLIBARR ERP CRM](https://www.dolibarr.org)
...
<!--
![Screenshot conditionreport](img/screenshot_conditionreport.png?raw=true "Conditionreport"){imgmd}
-->
...
Clone the repository in ```$dolibarr_main_document_root_alt/conditionreport```

```sh
cd ....../custom
git clone git@github.com:gitlogin/conditionreport.git conditionreport
```
