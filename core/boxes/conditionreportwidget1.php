...
/**
 * \file    conditionreport/core/boxes/conditionreportwidget1.php
 * \ingroup conditionreport
 * \brief   Widget provided by Conditionreport
 *
 ...
 */
class conditionreportwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "conditionreportbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "conditionreport@conditionreport";
	 ...
	 */
	public $depends = array('conditionreport');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "conditionreport@conditionreport"));
		...
		// $this->hidden = !$user->hasRight('conditionreport', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		$text = $langs->trans("ConditionreportBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_conditionreport@conditionreport',
