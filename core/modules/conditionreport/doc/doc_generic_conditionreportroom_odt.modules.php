...
/**
 *	\file       htdocs/core/modules/conditionreport/doc/doc_generic_conditionreportroom_odt.modules.php
 *	\ingroup    conditionreport
 *	\brief      File of class to build ODT documents for conditionreportrooms
 */
 ...
 */
class doc_generic_conditionreportroom_odt extends ModelePDFConditionreportroom
{
	/**
	 * Issuer
	 * @var Societe
	 ...
	 *
	 *	@param		Conditionreportroom	$object				Object source to build document
	...
	public function write_file($object, $outputlangs, $srctemplatepath, $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		if ($conf->conditionreport->dir_output) {
			...
			if (!is_object($object)) {
				$id = $object;
				$object = new Conditionreportroom($this->db);
