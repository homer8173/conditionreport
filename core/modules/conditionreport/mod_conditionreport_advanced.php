...
/**
 * \file       htdocs/core/modules/conditionreport/mod_conditionreport_advanced.php
 * \ingroup    conditionreport
 * \brief      File containing class for advanced numbering model of Conditionreport
 */
...
/**
 *	Class to manage the Advanced numbering rule for Conditionreport
 */
class mod_conditionreport_advanced extends ModeleNumRefConditionreport
{
	/**
	...
	public function info($langs)
	{
		...
		$tooltip .= $langs->trans("GenericMaskCodes4a", $langs->transnoentities("Conditionreport"), $langs->transnoentities("Conditionreport"));
	...
	public function getNextValue($object)
	{
		...
		$numFinal = get_next_value($db, $mask, 'conditionreport_conditionreport', 'ref', '', null, $date);
