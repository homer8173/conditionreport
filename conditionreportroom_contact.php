...
/**
 *  \file       conditionreportroom_contact.php
 *  \ingroup    conditionreport
 *  \brief      Tab for contacts linked to Conditionreportroom
 */
...
$title = $langs->trans("Conditionreportroom")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Conditionreportroom"), -1, $object->picto);
